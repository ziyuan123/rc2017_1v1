...
//  extern u32 X_0, X_1, X_2, X_3,Y_0,Y_1,Y_2,Y_3,X,Y;
 extern u8 UP_VoiceId,UP_CodeId,UP_ColorId;
...
extern void UP_Woody_Display_X_Y(void);
...
extern void UP_Woody_ImageRecForbidIssue();
extern void UP_Woody_ImageRecLetIssue();
#endif