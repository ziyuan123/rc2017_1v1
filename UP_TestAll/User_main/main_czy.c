...
const int kG4S_SensorData[4][G4S_SENSOR_DATA_LENGTH] = {
                                                        {3255+80,3180+80,3072+80,2870+80},
                                                        {3475+80,3400+80,3340+80,3198+80},
                                                        {3435+80,3380+80,3294+80,3145+80},
                                                        {3370+80,3290+80,3200+80,3042+80}};
...
int main(void) {
    ...
    UA01_GetOnStage1(DIRECTION_FORWARD);//上台
